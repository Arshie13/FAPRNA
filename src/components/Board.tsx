...
const allMembers = [
  {
    name: "Homer Tuazon",
    title: " MD, DNP, APRN, MSN, BSN,  BSP, PMHNP, DACACD. GHLP-F, WCS-C, EDS-C, CCRP, CCRA, CCRC",
          ...
          >
            ...
            <div className="w-full max-w-5xl mx-auto transition-all duration-500 ease-out transform">
              <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-blue-500/20 border border-blue-100/50 p-8 md:p-12 overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-center gap-8 lg:gap-16">
                  ...
                  <div className="flex flex-col items-center lg:items-center">
                    ...
                    <div className="mt-6 relative">
                      <div
                        ...
                        style={{ transitionDelay: imageLoaded && showContent && !isChanging ? "400ms" : "0ms" }}
                      >
                        <span className="text-lg font-semibold tracking-wide">{featured.role}</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="text-center lg:text-left">
                        <h1
                          ...
                          style={{ transitionDelay: imageLoaded && showContent && !isChanging ? "200ms" : "0ms" }}
                        >
                          {featured.name}
                        </h1>
                        {/* Credentials Box */}
                        <div
                          ...
                          style={{ transitionDelay: imageLoaded && showContent && !isChanging ? "500ms" : "0ms" }}
                        >
                      ...
                      <div
                        ...
                        style={{ transitionDelay: imageLoaded && showContent && !isChanging ? "600ms" : "0ms" }}
                      >
                        <div className="flex items-center gap-3 mb-4">
                          <div
                            className={`p-3 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl shadow-lg transition-all duration-500 ease-out ${
                              imageLoaded && showContent && !isChanging ? "rotate-0 scale-100" : "rotate-12 scale-90"
                            }`}
                            style={{ transitionDelay: imageLoaded && showContent && !isChanging ? "700ms" : "0ms" }}
                          >
                        ...
                        <div
                          ...
                          style={{ transitionDelay: imageLoaded && showContent && !isChanging ? "800ms" : "0ms" }}
                        >
                          <div
                            className={`p-3 bg-white rounded-full shadow-md border border-blue-200 transition-all duration-400 ease-out ${
                              imageLoaded && showContent && !isChanging ? "scale-100 rotate-0" : "scale-75 rotate-180"
                            }`}
                            style={{ transitionDelay: imageLoaded && showContent && !isChanging ? "900ms" : "0ms" }}
                          >
                            <Mail className="w-5 h-5 text-blue-600" />
                          </div>
                          <div className="flex-1">
                            <p
                              className={`text-sm text-slate-600 font-medium mb-1 transition-all duration-500 ease-out ${
                                imageLoaded && showContent && !isChanging
                                  ? "opacity-100 translate-y-0"
                                  : "opacity-0 translate-y-4"
                              }`}
                              style={{ transitionDelay: imageLoaded && showContent && !isChanging ? "1000ms" : "0ms" }}
                            >
                              Email Address
                            </p>
                            <a
                              ...
                              style={{ transitionDelay: imageLoaded && showContent && !isChanging ? "1100ms" : "0ms" }}
                            >
                              {featured.email}
                            </a>
                          </div>
