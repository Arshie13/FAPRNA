  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      const resizedOrbs = Array.from({ length: newOrbCount }).map(() => ({
        ...
        duration: Math.random() * 6 + 4,
        opacity:
          Math.random() * (isMobileNow ? 0.4 : 0.7) + (isMobileNow ? 0.2 : 0.3),
      }));
      setOrbs(resizedOrbs);
    };
...
export default function LuminanceAwards({ onVote }: LuminanceAwardsProps) {
  ...
  const inactiveButtonStyle = {
    ...
    animation: "gradient-shift 3s ease infinite",
    color: "#FFD700",
    boxShadow: "0 0 15px 0 rgba(255, 215, 0, 0.4)",
    ...
    <div className="bg-black text-white relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-8 sm:px-12 lg:px-16 pt-16 pb-8">
        ...
        <div className="text-center mb-12">
          <h1
            className="text-2xl lg:text-6xl md:text-4xl font-serif tracking-wider bg-clip-text text-transparent bg-[length:200%_auto] animate-text-shimmer animate-pulse drop-shadow-2xl animate-fade-in-up"
            style={{
              backgroundImage:
          ...
          <div
            className="w-48 h-1 mx-auto mt-6 rounded-full animate-fade-in-up animation-delay-200"
            style={{
              background:
                "linear-gradient(to right, transparent, #FFD700, #FFA500, #FFD700, transparent)",
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-12">
          <Button
            ...
            variant="outline"
            className="transition-all duration-300 backdrop-blur-sm text-lg px-8 py-4 transform hover:scale-105"
            style={!showHistory ? uniformButtonStyle : inactiveButtonStyle}
          >
          ...
          <div className="space-y-12">
            <div className="text-center">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to right, rgba(139, 92, 246, 0.5), #FFD700, rgba(139, 92, 246, 0.5))",
              ...
              >
                <p className="text-xl italic mb-6" style={{ color: "#FFD740" }}>
                  &quot;Previous award recipients will be showcased here as we
                  continue to honor excellence in Filipino-American advanced
                  practice nursing.&quot;
                </p>
                <p className="text-gray-300 text-lg">
                  Check back for updates on our distinguished alumni and their
                  continued contributions to the nursing profession.
                </p>
              </div>
            </div>
          </div>
